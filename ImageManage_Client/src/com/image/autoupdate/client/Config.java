 ...
 */
public class Config {
	private static Logger logger = Logger.getLogger(AutoUpdateClient.class);
	...
	public String getVerstion() {
		...
		List<Element> lst = doc.selectNodes("Info/Version");
	...
	public String getServerIp() {
		...
		List<Element> lst = doc.selectNodes("Info/UpdateServer/Ip");
		Element el = (Element) lst.get(0);
		return el.getText();
	}
	...
	public UpdFile[] getFiles() {
		...
		List<File> file = doc.selectNodes("Info/Files");
		List<Element> lst = ((Element) file.get(0)).elements();
		if (lst.size() == 0) {
			return null;
		}
	...
	public String getServerPort() {
		...
		List<Element> lst = doc.selectNodes("Info/UpdateServer/Port");
		Element el = (Element) lst.get(0);
		return el.getText();
	}

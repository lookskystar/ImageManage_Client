...
public class AppletParam {
	...
	public String validateUrl = "http://localhost:8080/Server_ImageManage/uploadAction!ajaxUploadInfo.do";//判断上传信息URL
	
	public String getDateUrl = "http://localhost:8080/Server_ImageManage/queryAction!ajaxAddJSONData.do";//ajax获取数据

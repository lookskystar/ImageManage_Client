...
import com.image.ui.FileInfoTableModel;
import com.image.ui.UIManager;
import com.image.util.FTPConst;
...
public class FTPFileUploadThread extends Thread {
	...
	public void run() {
		...
		try {
			ftp.connectAndLogin(FTPUtils.getResourceByKey("host"), Integer.parseInt(FTPUtils.getResourceByKey("port")),
					FTPUtils.getResourceByKey("userName"), FTPUtils.getResourceByKey("password"));
